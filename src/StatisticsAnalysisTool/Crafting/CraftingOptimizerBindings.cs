...
/// <summary>
/// Scans every craftable item (optionally filtered by tier) and ranks them by estimated crafting ROI,
/// reusing the same CraftingCalculator/CraftingRecipeResolver the single-item calculator uses.
/// Station fees are not modeled here (they depend on a specific crafting location) - results assume 0 station fee.
/// </summary>
public class CraftingOptimizerBindings : BaseViewModel
{
    ...
    public static string TranslationOptimizer => LocalizationController.Translation("CRAFTING_OPTIMIZER");
